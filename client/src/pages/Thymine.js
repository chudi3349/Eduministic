    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        ...
        <div className="grid justify-center grid-cols-1 gap-2 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
          <img className="flex p-6 text-6xl rounded-xl h-48 w-48" src="https://storage.echo3d.co/morning-hill-2019/ba1b490b-fad8-4f99-a1d6-97dbd9c81a4d.png" alt="QR Code" />
          <a href="https://go.echo3d.co/sooz" target="_blank" rel="noreferrer">
