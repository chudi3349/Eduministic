...
function Model({ ...props }) {
  ...
  const group = useRef()
  const { nodes, materials } = useGLTF('/thymine/scene.gltf')
...
function Details() {
  ...
  if (snap.current === "k3050f8") {
    ...
    return (
      <div className="h-full md:flex md:flex-col md:justify-center">
        <h1 className="text-2xl tracking-wider">Click on diffrent parts of Water Cycle 3D model to know more</h1>
        ...
        <div className="grid justify-center grid-cols-1 gap-2 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
          <img className="flex p-6 text-6xl rounded-xl h-48 w-48" src="https://storage.echo3d.co/morning-hill-2019/010502e2-a35e-46fe-a188-c6417b4678f6.png" alt="QR Code" />
...
export default function Thymine() {
  return (
    <>
      <div className="pt-8 text-white">
        ...
        <div className="grid w-full py-10 place-items-center">
          ...
          <div className="text-justify text-xl w-86 mt-2 mx-4 md:mx-44">Thymine (T) is one of four chemical bases in DNA, the other three being adenine (A), cytosine (C), and guanine (G). Within the DNA molecule, thymine bases located on one strand form chemical bonds with adenine bases on the opposite strand. The sequence of four DNA bases encodes the cell's genetic instructions. </div>
        </div>
