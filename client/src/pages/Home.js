    ...
    <div className='md:mx-28 mx-4 text-white pt-10 pb-12'>
      <div className='md:grid md:grid-cols-2 items-center pt-10'>
        <div className=''>
          ...
          <p className='text-xl md:text-2xl py-4 tracking-wider'>Eduministic is adopting a different approach to bringing chemistry home by simplifying the details that seemed difficult for many to understand using 3D models, and augmented reality of different topics.</p>
